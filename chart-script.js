...
function updateDependentFilters() {
  ...
  setOptions("gipfelFilter", unique(data, "Gipfel"));
  setOptions("routeFilter", unique(data, "Route"));
  setOptions("buchFilter", unique(data, "Buch"));
  setOptions("buchtypFilter", unique(data, "Buchtyp"));
  setOptions("erfasstFilter", unique(data, "Erfasste Jahre"));
  setOptions("jahrFilter", unique(data, "Jahr"));
  setOptions("monatFilter", unique(data, "Monat").map(m => String(m).padStart(2, "0")));
}
