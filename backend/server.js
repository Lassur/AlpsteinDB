...
// /api/eintraege – Suche, Filter, Limit
...
// /api/werte – Dropdown-Optionen dynamisch
app.get("/api/werte", async (req, res) => {
  try {
    ...
    const filter = {};
    Object.entries(andereFilter).forEach(([key, val]) => {
...
// /api/chart/jahr – gestapelte Jahresauswertung
